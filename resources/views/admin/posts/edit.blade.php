...
@section('content')
    <div class="d-flex justify-content-between shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <div class="d-flex align-items-center">
            <h1 class="mb-0 mr-3">Edit | <strong>{{$post->title}}</strong></h1>
        </div>
                ...
                <div class="form-group mb3">
                    ...
                    @foreach($categories as $category)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{$category->id}}" id="category{{$category->id}}" name="categories[]" @if($post->categories->contains($category->id)) checked @endif>
