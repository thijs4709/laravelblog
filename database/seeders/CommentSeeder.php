...
class CommentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($comments as $comment) {
            ...
            //Binnen de foreach-lus worden alle comments opgehaald voor dezelfde post als de huidige comment en krijgen ze willekeurig een parent toegewezen. Dit gebeurt door middel van de where()-methode van de Comment-klasse, die zoekt naar comments met dezelfde post_id en een id die lager is dan die van de huidige comment. Deze comments worden vervolgens in willekeurige volgorde gesorteerd met behulp van de inrandomOrder()-methode, en de eerste comment wordt toegewezen als de parent van de huidige comment. Als er geen geschikte parent comment gevonden wordt, krijgt de huidige comment geen parent_id toegewezen. Ten slotte wordt de comment opgeslagen met behulp van de save()-methode.
